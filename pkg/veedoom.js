...
* @returns {any}
*/
export function v(tag, props_val, children_val) {
    try {
        var ptr0 = passStringToWasm0(tag, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        var len0 = WASM_VECTOR_LEN;
        var ret = wasm.v(ptr0, len0, addBorrowedObject(props_val), addBorrowedObject(children_val));
...
* @returns {any}
*/
export function update(current_val, other_val) {
    try {
        var ret = wasm.update(addBorrowedObject(current_val), addBorrowedObject(other_val));
        return takeObject(ret);
    } finally {
        heap[stack_pointer++] = undefined;
        heap[stack_pointer++] = undefined;
